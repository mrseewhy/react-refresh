        ...
        <>
            <div className='flex justify-center items-center h-screen overflow-hidden'>
                <div className='w-1/3 mx-auto h-[65vh] bg-[url("./src/assets/react.svg")] bg-no-repeat bg-[position:200%_center] bg-[length:70%_auto] bg-blend-overlay bg-gray-900 rounded-2xl shadow-md text-white text-3xl '>
                    <div className='w-full h-1/6 bg-gray-950 rounded-t-2xl p-6 shadow-sm shadow-blue-400'>
                        <div className='flex flex-row justify-between items-center'>
                            <div className='flex flex-row gap-2'> <img src="./src/assets/react.svg" alt="" /> <p className='text-2xl font-bold text-cyan-400'>ReactFacts</p></div>
                            {/* <div>
                                <nav>
                    ...
                    <div className='w-full h-5/6  p-8 mt-4'>
                        ...
                        <ul className='text-sm mt-6 ml-4'>
                            <li className='mb-2 list-disc marker:text-cyan-500 marker:text-xl'>React is a JavaScript library for building user interfaces.</li>
                            <li className='mb-2 list-disc marker:text-cyan-500 marker:text-xl'>React is a JavaScript library for building user interfaces.</li>
                            <li className='mb-2 list-disc marker:text-cyan-500 marker:text-xl'>React is a JavaScript library for building user interfaces.</li>
                            <li className='mb-2 list-disc marker:text-cyan-500 marker:text-xl'>React is a JavaScript library for building user interfaces.</li>
                            <li className='mb-2 list-disc marker:text-cyan-500 marker:text-xl'>React is a JavaScript library for building user interfaces.</li>
